...
所以前送ALU操作数1口的条件应该是:
\begin{itemize}
    \item [1.] regw_exe && rs1_ID==rd_EXE && rs1use_ID
    \item [2.] regw_mem && rs1_ID==rd_MEM && rs1use_ID && ~mem_load
    \item [3.] regw_mem && rs1_ID==rd_MEM && rs1use_ID && mem_load
    \item [4.] others
\end{itemize}
...
前送ALU操作数2口的条件应该是：
\begin{itemize}
    \item [1.] regw_exe && rs2_ID==rd_EXE && rs2use_ID
    \item [2.] regw_mem && rs2_ID==rd_MEM && rs2use_ID && ~mem_load
    \item [3.] regw_mem && rs2_ID==rd_MEM && rs2use_ID && mem_load
    \item [4.] others
\end{itemize}
